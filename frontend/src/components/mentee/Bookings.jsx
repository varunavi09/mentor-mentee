    ...
    <div className="min-h-screen bg-gray-50 py-8">
      <div className="container mx-auto px-4">
        <div className="mb-8">
          ...
          <p className="text-gray-600">Track and manage your mentoring sessions</p>
        </div>
                        ...
                        <div className="flex items-center">
                          ...
                          <div>
                            ...
                            <p className="text-sm text-gray-500">
                              {booking.mentorId?.industry || 'Industry Professional'}
                            </p>
                          </div>
                        </div>
                      </td>
                        ...
                        <div className="flex space-x-2">
                          {booking.status === 'accepted' && (
                            <button
                              ...
                              className="bg-purple-600 text-white px-4 py-2 rounded-lg text-sm hover:bg-purple-700 transition font-semibold"
                            >
                              🎥 Join Session
                            </button>
                          )}
                          ...
                          {booking.status === 'declined' && (
                            <span className="text-gray-400 text-sm">Session declined</span>
                          )}
